    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:flex sm:-my-px sm:ms-10">
                    <x-nav-link :href="route('exchange-rates.index')" :active="request()->routeIs('exchange-rates.index')">
                        {{ __('Exchange Rates') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:flex sm:-my-px sm:ms-10">
                    <x-nav-link :href="route('cpi.index')" :active="request()->routeIs('cpi.index')">
                        {{ __('CPI Index') }}
                    </x-nav-link>
                </div>
            </div>
